function [ftot,zsim] = Con_Arm_cost(U,z0,parameters)
...
% Cost function generation f = Q'e_thQ + Qf'e_thQf + R'*u*R
F(1:3*N-3,1) = diagQ*(repmat(theta,N-1,1) - zsim(7:2:end-6,1));    
