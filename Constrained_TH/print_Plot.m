...
Ustar1=Ustar(1:3*N,1);

% Unpacking of thetas
theta1   = zstar1(1:6:end);
theta1d  = zstar1(2:6:end);
theta1dd = Ustar1(1:3:end);
theta2   = zstar1(3:6:end);
theta2d  = zstar1(4:6:end);
theta2dd = Ustar1(2:3:end);
theta3   = zstar1(5:6:end);
theta3d  = zstar1(6:6:end);
theta3dd = Ustar1(3:3:end);


EFspeed1 = EFspeedacc(zstar1,Ustar1,parameters);
...
hold off               
subplot(subplotnum,1,4),plot(T,EFspeed1,'r'),title('Speed of end effector'),
